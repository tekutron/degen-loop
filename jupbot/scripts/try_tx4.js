...
(async()=>{
  ...
  const body={ swapResponse: comp.data, txVersion, wallet: owner, wrapSol: true };
  try{
    const resp=await axios.post('https://transaction-v1.raydium.io/transaction/swap-base-in?computeUnitPriceMicroLamports=10000', body);
